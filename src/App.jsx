          ...
          <div className="w-3/4 md:w-1/2">
            ...
            <ul className="text-justify">
              ...
              <li>
                ...
                Unde aliquid eaque deserunt quasi itaque soluta quis
                reprehenderit eius blanditiis quidem asperiores provident natus
                velit, saepe odit eveniet. Itaque, magnam? Ea!
              </li>
              <li>
                3. Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Eaque at officia exercitationem hic nostrum architecto molestias
                vero voluptates non pariatur, natus quam, eos distinctio ex,
                minima consequuntur ipsam cupiditate consectetur?
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gray-200 py-14 flex flex-col justify-center items-center">
          ...
          <div className="w-3/4 md:w-1/2 flex flex-col gap-1">
            <p className="text-justify">
              ...
              quidem magni, veniam quis autem ea obcaecati illum rerum alias
              iure laboriosam officiis! Lorem, ipsum dolor sit amet consectetur
              adipisicing elit. Asperiores tempore voluptate nostrum ipsam atque
              sit expedita eum quidem magni, veniam quis autem ea obcaecati
              illum rerum alias iure laboriosam officiis!
            </p>
            <p className="text-justify">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Asperiores tempore voluptate nostrum ipsam atque sit expedita eum
              quidem magni, veniam quis autem ea obcaecati illum rerum alias
              iure laboriosam officiis!
            </p>
            <p className="text-justify">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Asperiores tempore voluptate nostrum ipsam atque sit expedita eum
